...
def evaluate(user_emb, item_emb, n_users, n_items, train_U2I, test_U2I, args):
    ...
    # if args.dataset_name == 'AmazonCell_Single':
    #     perf_info = perf_info*5
    # elif args.dataset_name == 'AmazonElec_Single':
    #     perf_info = perf_info*5
    # elif args.dataset_name == 'AmazonCloth_Single':
    #     perf_info = perf_info*5
    # elif args.dataset_name == 'AmazonSport_Single':
    #     perf_info = perf_info*5
