...
class Session(object):
    ...
    def train(self, loader, optimizer, args):
        ...
        for uij in loader:
            ...
            user_emb, item_emb, user_emb0, item_emb0 = self.model.propagate()
            user_emb, pos_emb, neg_emb = self.model.get_embedding(user_emb, item_emb, u, i, j)
            user_emb0, pos_emb0, neg_emb0 = self.model.get_embedding(user_emb0, item_emb0, u, i, j)
            bpr_loss, mf_loss, reg_loss = self.model.bpr_loss(user_emb, pos_emb, neg_emb, user_emb0, pos_emb0, neg_emb0)
